      ...
      >
        ...
        <div class="absolute bottom-[65%] left-[3%] lg:bottom-64 lg:left-[21%] ">
          <div class="md:-space-y-1 lg:-space-y-1">
            <h1 class="text-3xl md:text-6xl lg:text-[6rem] font-medium">Welcome to tokyo</h1>
            <h1 class="text-3xl md:text-6xl lg:text-[6rem] font-medium text-strok">Live the beauty</h1>
          </div>
